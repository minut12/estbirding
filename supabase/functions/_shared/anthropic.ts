...
1) LATIN BINOMIALS (e.g. "Vanellus gregarius", "Haliaeetus albicilla", "Pelecanus crispus") — preserve EXACTLY. Never translate, decline, or change capitalization. Keep italics/parentheses if the source has them.
