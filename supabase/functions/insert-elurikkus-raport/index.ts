...
const RESIDENT_EXCLUSIONS: ReadonlySet<string> = new Set([
  // Genuine year-round residents — these are filtered regardless of date.
  // For all other species, the date filter (below) catches early-spring
  // migrants whose true first 2026 obs predates the current period_start.
