...
revoke all on function public.bulk_upsert_ebird_rare_observations(jsonb, jsonb) from public;
grant execute on function public.bulk_upsert_ebird_rare_observations(jsonb, jsonb) to service_role;